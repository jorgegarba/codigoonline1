...
var boton1js = document.getElementById("boton1");
boton1js.innerText = "Nuevo texto";
console.log(boton1js); // capturando al boton por jquery
// $ => simbolo del dolar => es el simbolo que reprenta a jquery
// 

$("#boton1").text("Un nuevo texto"); // seleccionar varios elementos con jquery
// con js puro => boton1js.style.borderRadius = "12px";
// jquery.css("propiedad css","valor") =>  modifica estilos a un elemento

$(".btn").css("border-radius", "0"); //  la mejor forma en js puro para el codigo de arriba, sería:
