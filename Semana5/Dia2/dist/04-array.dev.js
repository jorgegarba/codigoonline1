...
var numeros = [2, 4, 6, 8, 10, 12, 14, 16]; // arreglo.pop()
...
var buscar900 = numeros.indexOf(900);
...
numeros.forEach(function (nro, i) {
  console.log("Indice ".concat(i, ", Elemento ").concat(nro));
}); // ----------------
// arreglo.filter(()=>{})
...
var mayoresQue100 = numeros.filter(function (elemento, i) {
  if (elemento > 100) {
    return elemento;
  }
});
...
var dobles = numeros.map(function (n, i) {
  return n * 2;
});
console.log(dobles);