...
// Math.ceil(numero) análogo a floor, redondea un número al 
// próximo entero (techo del numero).
console.log(Math.ceil(2.0001));


// Math.round(numero) redondea un número de acuerdo al estandar
...
// Artificio para hallar un numero random entre 2 numeros
