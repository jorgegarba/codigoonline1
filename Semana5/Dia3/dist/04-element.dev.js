...
var titulo = document.querySelector("#titulo"); // let titulo = document.getElementById("titulo");
// propiedad STYLE de tooooodos los elementos
// elemento.style.color settea el color de texto o contenido de un elemento

titulo.style.color = "#ff0000"; // TODOS LOS ESTLOS EN JAVASCRIPT, son iguales que en CSS, excpeto que,
...
var parrafo = document.getElementById("parrafo"); // elemento.clientWidth => devuelve el ancho del elemento incluido el relleno
// elemento.clientHeight => devuelve el alto del elemento incluido el relleno

console.log("ancho " + parrafo.clientWidth);
console.log("alto " + parrafo.clientHeight); // elemento.offsetTop => Devuelve la cantida de pixeles que el elemento se desplaza desde
...
console.log(parrafo.offsetWidth); // elemento.scrollTop => cantidad de pixeles en los que el contenido del elemento
// se ha desplazado en la parte superior
// PENDIENTE => PARA USARLO CON LA PROPIEDAD html, pero con LISTENERS

console.log(parrafo.scrollTop); // EJEMPLO>
...
console.log(miSection.classList); // elemento.classList.remove("nombre_de_clase_a_borrar")

miSection.classList.remove("fondo-naranja"); // elemento.classList.add("nombre_de_clase_a_agregar")

miSection.classList.add("success"); // elemento.innerHTML get y set del contenido del elemento
// OJO si dicho contenido, tiene codigo HTML, éste es renderizado como
// parte del DOM

miSection.innerHTML = "<a href=\"https://www.google.com\"> Click Aqui</a>"; // elemento.innerTEXT get y set del contenido del elemento
