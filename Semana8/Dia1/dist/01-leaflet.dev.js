...
var mymap = L.map('mapid').setView([-16.4028734, -71.5137748], 13);
...
var polygon = L.polygon([[-16.40289, -71.6], [-16.44, -71.62], [-16.46, -71.68]]).addTo(mymap);
marker.bindPopup("<b>Hello world!</b><br>I am a popup.").openPopup();
circle.bindPopup("I am a circle.");
polygon.bindPopup("I am a polygon.");

var colocarMarcador = function colocarMarcador(_ref) {
